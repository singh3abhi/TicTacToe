...
import 'package:my_tictactoe/resources/socket_client.dart';
...
class SocketMethods {
  ...
  void tappedListener(BuildContext context) {
    _socketClient.on('tapped', (data) {
      ...
      // After every tap we need to check winner
  ...
  void endGameListener(BuildContext context) {
    _socketClient.on("endGame", (playerData) {
      showRestartGame(context, '${playerData['nickname']} won the game!');
    });
  }
}
